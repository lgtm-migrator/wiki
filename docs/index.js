...
(function() {
  ...
  function b(a, b) {
    ...
    this.options.gfm
      ? (this.rules = this.options.breaks ? j.breaks : j.gfm)
    ...
    if (f || "function" == typeof e) {
      ...
      try {
        ...
        if (
          ...
          return (
            "<p>An error occured:</p><pre>" + d(o.message + "", !0) + "</pre>"
          );
        throw o;
      }
  }
  ...
  (i.bullet = /(?:[*+-]|\d+\.)/),
    ...
    (i.list = e(i.list)(/bull/g, i.bullet)(
      "hr",
      /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/
    )()),
    (i._tag =
    ...
    (i.html = e(i.html)("comment", /<!--[\s\S]*?-->/)(
      "closed",
      /<(tag)[\s\S]+?<\/\1>/
    )("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, i._tag)()),
    (i.paragraph = e(i.paragraph)("hr", i.hr)("heading", i.heading)(
      "lheading",
      i.lheading
    )("blockquote", i.blockquote)("tag", "<" + i._tag)("def", i.def)()),
    (i.normal = g({}, i)),
    (i.gfm = g({}, i.normal, {
      fences: /^ *(`{3,}|~{3,}) *(\S+)? *\n([\s\S]+?)\s*\1 *(?:\n+|$)/,
      paragraph: /^/
    })),
    (i.gfm.paragraph = e(i.paragraph)(
      "(?!",
      "(?!" + i.gfm.fences.source.replace("\\1", "\\2") + "|"
    )()),
    (i.tables = g({}, i.gfm, {
      nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
      table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
      ...
      for (var b, c, e, f, g = ""; a; )
        if ((f = this.rules.escape.exec(a)))
          ...
          (a = a.substring(f[0].length)),
            "@" === f[2]
              ? ((c = this.mangle(":" === f[1][6] ? f[1].substring(7) : f[1])),
          ...
          (a = a.substring(f[0].length)),
            (g += this.options.sanitize ? d(f[0]) : f[0]);
          ...
          (f = this.rules.reflink.exec(a)) ||
          (f = this.rules.nolink.exec(a))
        ) {
          if (
            ((a = a.substring(f[0].length)),
          ...
          (a = a.substring(f[0].length)),
            (g += "<strong>" + this.output(f[2] || f[1]) + "</strong>");
        else if ((f = this.rules.em.exec(a)))
          (a = a.substring(f[0].length)),
            (g += "<em>" + this.output(f[2] || f[1]) + "</em>");
      ...
      switch (this.token.type) {
        ...
        case "code":
          if (this.options.highlight) {
            ...
            null != a &&
              a !== this.token.text &&
              ((this.token.escaped = !0), (this.token.text = a));
          }
          return (
        ...
        case "table":
          ...
          for (
            h += "</tr>\n</thead>\n", h += "<tbody>\n", c = 0;
            c < this.token.cells.length;
            c++
          ) {
            for (
              e = this.token.cells[c], h += "<tr>\n", g = 0;
              g < e.length;
              g++
            )
        ...
        case "list_start":
          for (
            var i = this.token.ordered ? "ol" : "ul", h = "";
    ...
    a.Stage = function(c) {
      ...
      return (
        ...
        (d.subscribe = function(b) {
          d.started && a.error("Subscribing to stage which already started!"),
            d.events.push(b);
        }),
          ...
          d.outstanding.push(f),
            a.md.util.wait(2500).done(function() {
              "resolved" !== f.state() &&
                ...
                b.fatal(
                  "stage " + c + " failed running subscribed function: " + e
                ));
            });
          var g = function() {
            f.resolve();
  ...
  (function(a) {
    ...
    function b() {
      (a.md.stages = [
        ...
        (a.md.stage = function(b) {
          ...
          return 0 !== c.length
            ? c[0]
            : void a.error("A stage by name " + b + "  does not exist");
        });
    }
      ...
      a.md.stage("init").subscribe(function(b) {
        ...
        a.md.stage("transform").subscribe(function(b) {
          if ("" === r) {
            ...
            return (
              c.info("no navgiation.md found, not using a navbar"), void b()
            );
          }
          var d = marked(r),
            e = a("<div>" + d + "</div>");
    ...
    function m() {
      a.md.stage("init").done(function() {
        ...
        a.md.stage("final_tests").done(function() {
          c(),
            a("body").append('<span id="start-tests"></span>'),
            a("#start-tests").hide();
        }),
        a.md.stage("init").run();
    }
    ...
    function n() {
      var b;
      (b = window.location.hash.substring(
        window.location.hash.startsWith("#!") ? 2 : 1
      )),
        (b = decodeURIComponent(b));
      var c = b.indexOf("#");
      -1 !== c
        ? ((a.md.inPageAnchor = b.substring(c + 1)),
          (a.md.mainHref = b.substring(0, c)))
        : (a.md.mainHref = b);
    }
    ...
    a
      ...
      a
        ...
        .fail(function(b, c) {
          p.error("unable to retrieve config.json: " + c),
            a.md.ConfigDfd.reject();
        }),
  ...
  (function($) {
    ...
    function checkLicense(a, b) {
      if (-1 === $.inArray(a, licenses)) {
        ...
        log.warn("license " + a + " is not known."),
          log.warn("Known licenses:" + c);
      } else
        "OTHER" === a &&
          log.warn(
            "WARNING: Module " +
    ...
    function loadScript(a) {
      ...
      checkLicense(e, b),
        log.debug(
          "subscribing " + b.name + " to start: " + f + " end in: " + g
        ),
        $.md.stage(f).subscribe(function(a) {
          c.startsWith("//") || c.startsWith("http")
            ? $.getScript(c, function() {
                void 0 !== h
                  ? h(a)
                  : (log.debug("module" + b.name + " script load done: " + c),
                    a()),
                  i.resolve();
              })
    ...
    function findActiveLinkTrigger() {
      ...
      a.each(function(a, b) {
        ...
        -1 === activeLinkTriggers.indexOf(c.trigger) &&
      ...
      $.each(activeLinkTriggers, function(a, b) {
        ...
        if (void 0 === c)
          return void log.error(
            'Gimmick link: "' + b + '" found but no suitable gimmick loaded'
          );
    ...
    function subscribeLinkTrigger(a, b, c) {
      log.debug(
        "Subscribing gimmick " + c.module.name + " to stage: " + c.stage
      ),
    ...
    ($.md.registerGimmick = function(a) {
      ...
      ($.md.registerCss = function(a, b, c) {
        ...
        checkLicense(d, a);
        var g =
          '<link rel="stylesheet" href="' + b + '" type="text/css"></link>';
  ...
  (function(a) {
      ...
      a("#md-content p").each(function() {
        ...
        if (0 !== a.trim(b.text()).length) {
          ...
          b.wrapInner('<div class="md-text" />'),
            0 !== c.length &&
              (c.prependTo(b), b.addClass("md-floatenv").addClass(d));
        }
      });
    }
    ...
    function g() {
      ...
      return c.each(function() {
        ...
        void 0 === d && (d = ""),
          b.wrap(
            '<a class="md-image-selfref" href="' + c + '" title="' + d + '"/> '
          );
      });
    }
      ...
      function c(b) {
        if (a.md.config.useSideMenu !== !1 && "H2" === b.prop("tagName")) {
          ...
          if ("" !== c) {
            ...
            d.click(function(b) {
              b.preventDefault(),
                a("body").scrollTop(a("#md-page-menu").position().top);
            }),
  ...
  (function(a) {
        ...
        a(window).scroll(function() {
          ...
          a("*.md-inpage-anchor").each(function(c, d) {
            ...
            a("#md-page-menu a").each(function(c, d) {
              ...
              b &&
                e.toptext() === b.toptext() &&
                (a("#md-page-menu a.active").removeClass("active"),
                e.addClass("active"));
            });
        });
    ...
    function m() {
      ...
      (b += '<hr><div class="scontainer">'),
        ...
        (b += 'Generated By <a href="http://www.mdwiki.info">MDwiki</a> '),
        (b += "</div>");
      var c = a(b);
    ...
    (a.mdbootstrap = function(b) {
      return a.mdbootstrap.publicMethods[b]
        ? a.mdbootstrap.publicMethods[b].apply(
            this,
            Array.prototype.slice.call(arguments, 1)
          )
  ...
  (function(a) {
    function b(b, c) {
      ...
      return (
        ...
        b.each(function(b, c) {
          ...
          h.attr("data-href", g),
            h.attr("data-layout", f.layout),
            h.attr("data-show-faces", f.showfaces),
            d.replaceWith(h);
        })
      );
    }
    var c = window.navigator.userLanguage || window.navigator.language,
      ...
      h = {
        ...
        version: a.md.version,
        once: function() {
          a.md.linkGimmick(this, "facebooklike", b),
            a.md.registerScript(this, g, {
              license: "APACHE2",
  ...
  (function(a, b, c, d) {
    ...
    function e(b) {
      ...
      if (-1 !== b.indexOf('rel="stylesheet"'))
        (f = a(b).attr("href")),
          -1 === a.inArray(f, k) && (a("head").append(b), k.push(f));
        ...
        init: function(b) {
          return (
            ...
            a.each(f, function(a, b) {
              if ("string" != typeof b)
                throw new TypeError(b + " (" + typeof b + ") is not a string");
            }),
            this.lazygist("load")
          );
        },
  ...
  (function(a) {
    ...
    var b = [
        ...
        },
        {
          name: "cerulean",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/cerulean/bootstrap.min.css"
        },
        {
          name: "cosmo",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/cosmo/bootstrap.min.css"
        },
        {
          name: "cyborg",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/cyborg/bootstrap.min.css"
        },
        {
          name: "flatly",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/flatly/bootstrap.min.css"
        },
        {
          name: "journal",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/journal/bootstrap.min.css"
        },
        {
          name: "readable",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/readable/bootstrap.min.css"
        },
        {
          name: "simplex",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/simplex/bootstrap.min.css"
        },
        {
          name: "slate",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/slate/bootstrap.min.css"
        },
        {
          name: "spacelab",
          url:
            "netdna.bootstrapcdn.com/bootswatch/3.0.0/spacelab/bootstrap.min.css"
        },
        {
          name: "united",
          url:
      ...
      d = {
        ...
        version: a.md.version,
        once: function() {
          a.md.linkGimmick(this, "themechooser", h, "skel_ready"),
            a.md.linkGimmick(this, "theme", g);
        }
      };
    a.md.registerGimmick(d);
    var e = a.md.getLogger(),
      f = function(c) {
        if (((c.inverse = c.inverse || !1), void 0 === c.url)) {
          ...
          if (!d)
            return void e.error("Theme " + name + " not found, removing link");
          c = a.extend(c, d);
        }
  ...
  (function(a) {
    var b = a.md.prepareLink("platform.twitter.com/widgets.js"),
      ...
      d = {
        ...
        version: a.md.version,
        once: function() {
          a.md.linkGimmick(this, "twitterfollow", e),
    ...
    var e = function(b) {
      return b.each(function(b, c) {
        ...
        if (f.indexOf("twitter.com") <= 0) {
          (d = e.attr("href")),
            (f = a.md.prepareLink("twitter.com/" + d)),
            "@" === d[0] && (d = d.substring(1));
          var g = a(
            '<a href="' +
              f +
